...
?>
		...
		<?php
			...
			if ($_SESSION['bib_nivell'] <= $privilegi_avancat) {
				//echo "<hr><br>\n";
				echo "<form action=\"especifica_cerca.php\" method =\"POST\">\n";
					echo "<h3>Cerca específica</h3>\n";
					echo "<div class=\"entrada\"><div class=\"etiqueta\">Núm. de fitxa</div>\n";
					echo "<div class=\"valor\"><input type=\"number\" size=40 name=\"id_fitxa\"></div></div>";
					echo "<div class=\"entrada\"><div class=\"etiqueta\">Núm. de registre</div>\n";
